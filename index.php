...
$select_pizzas = "SELECT * FROM `pizza`";
...
<body>
        ...
        <div class="container">
            <div class="collapse navbar-collapse" id="navbarsExample07">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a href="../WolfiePizza/index.php"><img src="images/WolfiePizza_free-file.png" class="company-icon" alt=""></a>
                    </li>
                    <li class="nav-item m25-10">
                        <a class="nav-link active" aria-current="page" href="../WolfiePizza/index.php">Main</a>
                    </li>
                    ...
                    if (empty($_SESSION['login']) and empty($_SESSION['id'])) {
                        echo "
                            <li class='nav-item m25-10'>
                                <a class='nav-link active' aria-current='page' href='scripts/login.php'>Sign in</a>
                            </li>
                            <li class='nav-item m25-10'>
                                <a class='nav-link active' aria-current='page' href='scripts/register.php'>Sign up</a>
                            </li>
                        ";
                    } else {
                        echo "
                            ...
                            <li class='nav-item m25-10'>
                                <a class='nav-link active' aria-current='page' href='scripts/sign-out.php'>Sign out</a>
                            </li>
                        ";
                    }
                    if ($_SESSION['login'] == 'admin') {
                        echo "
                            ...
                            <ul class='dropdown-menu'>
                            <li><a class='dropdown-item' href='scripts/add-pizza.php'>Add Pizza</a></li>
                            <li><a class='dropdown-item' href='scripts/add-category.php'>Add Category</a></li>
                            <li><a class='dropdown-item' href='scripts/edit-category.php'>Edit Category</a></li>
                            <li><a class='dropdown-item' href='scripts/delete-category.php'>Delete Category</a></li>
                            </ul>
                        ";
                    }
                    ?>
                </ul>
                <form role="search" action="scripts/search-pizzas.php" method="get">
    ...
    <div class="container">
        <h1 id="all-pizzas">All Pizzas</h1>
    </div>
    <div class="container">
        <div class="pizzas">
            ...
            ?>
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <?php }
                            ?>
                            <a href="scripts/show-pizza.php?id=<?= $pizzas['id'] ?>" class="btn btn-primary" style="margin-bottom: 5px">More</a>
                            <?php if ($_SESSION['login'] == 'admin') { ?>
                                <a href="scripts/edit-pizza.php?id=<?= $pizzas['id'] ?>&category_id=<?= $pizzas['category_id'] ?>" class="btn btn-primary" style="margin-bottom: 5px">Edit Pizza</a>
                                <a href="scripts/delete-pizza.php?id=<?= $pizzas['id'] ?>" class="btn btn-primary">Delete Pizza</a>
                            <?php } ?>
                        </div>
                    </div>
            <?php }
