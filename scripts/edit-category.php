...
<body>
    ...
    <div class="container">
        ...
        <form action="update-category.php" class='add-category' method="post">
        <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name='category-name' required placeholder="Enter new category name">
            </div>
