...
<body>
    ...
    <div class="container">
        ...
        <form action="insert-category.php" class='add-category' method="post" enctype='multipart/form-data'>
            <div class="mb-3">
                <label for="category-name" class="form-label">Category name</label>
                <input type="text" class="form-control" name='category-name' required placeholder="Enter category name">
            </div>
