...
<body>
    ...
    <div class="container">
        <?php
        if($_SESSION['login'] == 'admin') {
            if (!$mysqli->query($delete_sql_one)) { ?>
            <div class='alert alert-danger' role='alert'>Error in deleting pizzas with equal category in the database!</div>
        <?php
            } else {
        ?>
            <div class='alert alert-success' role='alert'>Success on deleting pizzas with equal category!</div>
        <?php
            };
        ?>
        <?php
        if($_SESSION['login'] == 'admin') {
            ...
            <div class='alert alert-danger' role='alert'>Error in deleting the category in the database!</div>
        <?php
            } else {
        ?>
            <div class='alert alert-success' role='alert'>Success on deleting category!</div>
