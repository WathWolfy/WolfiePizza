...
<body>
    ...
    <div class="container">
        ...
        <h1 class='h1-style'>Add Pizza</h1>
        <form action="insert-pizza.php" class='add-pizza-form' method="post" enctype='multipart/form-data'>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name='pizza-name' required placeholder="Enter pizza name">
            </div>
            <div class="mb-3">
                <label for="pizza-description" class="form-label">Pizza description</label>
                <textarea class="form-control" name='pizza-description'required placeholder="Enter description" rows="3"></textarea>
            </div>
            <div class="mb-3">
