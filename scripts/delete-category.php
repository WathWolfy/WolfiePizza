...
<body>
    ...
    <div class="container">
        ...
        <h1 class='h1-style'>Delete Category</h1>
        <form action="erase-category.php" class='add-category' method="post">
        <div class="mb-3">
            ...
            <button type="submit" class="btn btn-primary col-1">Delete</button>
        </form>
        <?php } else { ?>
