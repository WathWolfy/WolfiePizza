...
$insert_sql = <<<HEREDOC
INSERT INTO `pizza` ( `category_id`, `name`, `image`, `description`) VALUES (
    '$category_id',
    '$name',
    '$upload_filename',
    '$description'
...
<body>
    ...
    <div class="container">
        ...
        if($_SESSION['login'] == 'admin') {
            ...
            <div class='alert alert-danger' role='alert'>Error in sending the image to the database!</div>
        <?php
            } else {
        ?>
            <div class='alert alert-success' role='alert'>Success on adding pizza!</div>
