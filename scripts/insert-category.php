...
$category_name = trim($_REQUEST['category-name']);
...
<body>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    if ($_SESSION['login'] == 'admin') {
                        echo "
                                ...
                                <li><a class='dropdown-item' href='delete-category.php'>Delete Category</a></li></ul>
                            ";
                    }
                    ?>
                </ul>
    ...
    <div class="container">
        ...
        if($_SESSION['login'] == 'admin') {
            ...
            <div class='alert alert-danger' role='alert'>Error in sending the category to the database!</div>
        <?php
            } else {
        ?>
            <div class='alert alert-success' role='alert'>Success on adding category!</div>
