...
<body>
    ...
    <div class="container">
        ...
        if($_SESSION['login'] == 'admin') {
            ...
            <div class='alert alert-danger' role='alert'>Error in updating the category in the database!</div>
        <?php
            } else {
        ?>
            <div class='alert alert-success' role='alert'>Success on updating category!</div>
